...
export const newsTypeEnum     = pgEnum("news_type",     ["urgent", "hr", "corporate", "task", "external", "task_new", "task_accepted", "task_review", "task_returned", "approval", "task_stuck", "task_escalated"]);
